...
copy_tree_with_progress "$PI_DIR/lib" "$TARGET/lib"
copy_tree_with_progress "$PI_DIR/api" "$TARGET/api"
copy_tree_with_progress "$PI_DIR/local" "$TARGET/local"
copy_tree_with_progress "$PI_DIR/widgets" "$TARGET/widgets"
run_step "Copying config.json" cp "$PI_DIR/config.json" "$TARGET/config.json"
run_step "Copying main.py -> code.py" cp "$PI_DIR/main.py" "$TARGET/code.py"
